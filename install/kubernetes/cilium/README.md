...
| clustermesh.apiserver.image | object | `{"pullPolicy":"Always","repository":"quay.io/cilium/clustermesh-apiserver","sha":"","tag":"latest","useSHA":false}` | Clustermesh API server image. |
...
| hubble.relay.image | object | `{"pullPolicy":"Always","repository":"quay.io/cilium/hubble-relay","sha":"","tag":"latest","useSHA":false}` | Hubble-relay container image. |
...
| image | object | `{"pullPolicy":"Always","repository":"quay.io/cilium/cilium","sha":"","tag":"latest","useSHA":false}` | Agent container image. |
...
| operator.image | object | `{"awsSHA":"","azureSHA":"","genericSHA":"","legacySHA":"","pullPolicy":"Always","repository":"quay.io/cilium/operator","suffix":"","tag":"latest","useSHA":false}` | cilium-operator image. |
...
| preflight.image | object | `{"pullPolicy":"Always","repository":"quay.io/cilium/cilium","sha":"","tag":"latest","useSHA":false}` | Cilium pre-flight image. |
